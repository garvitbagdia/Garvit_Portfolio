...
const Work = () => {
  ...
  return (
    <section
      id="work"
      className="py-24 px-6 md:px-16 lg:px-24 font-sans relative overflow-x-hidden"
    >
      {/* Section Title */}
      <div className="text-center mb-16">
        ...
        <p className="text-gray-400 mt-4 text-lg font-semibold max-w-3xl mx-auto">
          ...
          and experience in modern web technologies.
        </p>
      </div>

      {/* Projects Grid (2 Cards Only) */}
      <div className="grid gap-10 grid-cols-1 md:grid-cols-2 place-items-center max-w-5xl mx-auto">
        {projects.map((project) => (
          <div
            key={project.id}
            onClick={() => setSelectedProject(project)}
            className="max-w-sm w-full border border-white bg-gray-900 backdrop-blur-md rounded-2xl shadow-2xl overflow-hidden cursor-pointer hover:shadow-purple-500/50 hover:-translate-y-2 transition-all duration-300"
          >
            <div className="p-4">
              <img
                src={project.image}
