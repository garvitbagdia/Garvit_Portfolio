...
const Skills = () => (
  <section
    id="skills"
    className="py-24 px-6 md:px-16 lg:px-24 font-sans bg-skills-gradient clip-path-custom overflow-x-hidden"
  ...
  >
    ...
    <div className="text-center mb-8">
      ...
      <p className="text-gray-400 mt-4 text-lg font-semibold max-w-2xl mx-auto">
        A collection of my technical skills with a strong focus on backend and
